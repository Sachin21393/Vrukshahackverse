...
class _HomeScreenNewState extends State<HomeScreenNew> {
  ...
  final List<Product> bestsellers = [
    Product('assets/images/bs1.png', 'Pothos', 75),
    Product('assets/images/bs2.png', 'Peace Lily', 130),
    Product('assets/images/bs3.png', 'Money Plant', 45),
  ];

  final List<Blog> blogs = [
    Blog('assets/images/blog1.png', 'How to grow a plant'),
    Blog('assets/images/blog2.png', 'Planting tips'),
    Blog('assets/images/task2.png', 'How to grow a plant'),
    Blog('assets/images/task3.png', 'How to grow a plant'),
  ];
